...
type IdeasScreenProps = NativeStackScreenProps<RootStackParamList, 'Ideas'>;
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={[styles.iconCircle, { backgroundColor: '#FF1493' }]}>
          <Lightbulb color="#FFFFFF" size={64} />
        </View>
        <Text style={styles.title}>Ideas</Text>
        <Text style={styles.description}>
          Capture your brilliant ideas and inspirations all in one place.
        </Text>
      </View>
    </View>
  );
